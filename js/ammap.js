(function () {
    ...
    d.applyLang = function (a, b) {
        ...
        c &&
            ...
            ((d.lang = c),
            (b.langObj = c),
            c.monthNames && ((b.dayNames = d.extend({}, c.dayNames)), (b.shortDayNames = d.extend({}, c.shortDayNames)), (b.monthNames = d.extend({}, c.monthNames)), (b.shortMonthNames = d.extend({}, c.shortMonthNames))),
    ...
    d.addGlobalListeners = function () {
        d.globalListenersAdded ||
            ...
            d.isNN &&
                (document.addEventListener("mousemove", d.handleMouseMove), document.addEventListener("keyup", d.handleKeyUp), document.addEventListener("mouseup", d.handleMouseUp, !0), window.addEventListener("load", d.handleLoad, !0)),
    ...
    d.addWheelListeners = function () {
        d.wheelIsListened ||
            (d.isNN && (window.addEventListener("DOMMouseScroll", d.handleWheel, { passive: !1, useCapture: !0 }), document.addEventListener("mousewheel", d.handleWheel, { passive: !1, useCapture: !0 })),
...
(function () {
        ...
        if (1 < a)
            for (h = b.length - 1; -1 < h; h--) {
                if (
                    ...
                    1 > m && (m = 1),
                    (c = d.roundTo(l, m)),
                    (m = d.formatNumber(c, { precision: -1, decimalSeparator: e.decimalSeparator, thousandsSeparator: e.thousandsSeparator })),
                    !g || l == c)
                ) {
                    f = k + "" + m + "" + b[h].prefix;
                    break;
    ...
    d.deleteObject = function (a, b) {
        if (a) {
            ...
            if (0 !== b)
                if ("[object Array]" === Object.prototype.toString.call(a)) for (var c = 0; c < a.length; c++) d.deleteObject(a[c], b - 1), (a[c] = null);
                else if (a && !a.tagName)
                    try {
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e) for (var g = 0; g < a[c].length; g++) (e = document.createElementNS(d.SVG_NS, c)), b.appendChild(e), d.parseDefs(a[c][g], e);
...
(function () {
    ...
    d.AmDraw = d.Class({
        construct: function (a, b, c, e) {
            ...
            d.hasSVG
                ? ((d.SVG = !0), (b = this.createSvgElement("svg")), a.appendChild(b), (this.container = b), this.addDefs(e), (this.R = new d.SVGRenderer(this)))
                : d.isIE &&
                  d.VMLRenderer &&
                  ((d.VML = !0),
                  d.vmlStyleSheet ||
                      ...
                      31 > document.styleSheets.length
                          ? ((b = document.createStyleSheet()), b.addRule(".amvml", "behavior:url(#default#VML); display:inline-block; antialias:true"), (d.vmlStyleSheet = b))
        ...
        addDefs: function (a) {
            if (d.hasSVG) {
                ...
                a &&
                    ...
                    a.accessibleDescription && ((b.innerHTML = ""), b.appendChild(document.createTextNode(a.accessibleDescription))),
                    c.appendChild(b),
...
(function () {
    ...
    d.AmChart = d.Class({
        ...
        afterWrite: function (a) {
            ...
            if ((b = "object" != typeof a ? document.getElementById(a) : a)) {
                ...
                if (e) {
                    ...
                    if (e.enabled)
                        switch (
                            ((g.left = null), (g.top = null), (g.right = null), (f.left = null), (f.right = null), (f.top = null), (g.position = "relative"), (f.position = "relative"), (k.width = "100%"), (k.height = "100%"), e.position)
                        ) {
                            case "bottom":
                                h.appendChild(a);
                                h.appendChild(c);
        ...
        initChart: function () {
            ...
            this.destroy();
            (a = this.container)
                ? ((a.container.innerHTML = ""), (a.width = this.realWidth), (a.height = this.realHeight), a.addDefs(this), this.chartDiv.appendChild(a.container))
        ...
        measure: function () {
            ...
            if (a) {
                ...
                (c != this.previousWidth || e != this.previousHeight) &&
                    0 < a &&
                    0 < f &&
                    ((b.style.width = a + "px"), (b.style.height = f + "px"), (b.style.padding = 0), g && g.setSize(a, f), (this.balloon = d.processObject(this.balloon, d.AmBalloon, this.theme)));
        ...
        checkTransform: function (a) {
            if (this.autoTransform && window.getComputedStyle && a) {
                if (a.style) {
                    ...
                    if (
                        b &&
                        (b = b.getPropertyValue("-webkit-transform") || b.getPropertyValue("-moz-transform") || b.getPropertyValue("-ms-transform") || b.getPropertyValue("-o-transform") || b.getPropertyValue("transform")) &&
                        "none" !== b
                    ) {
        ...
        dispDUpd: function () {
            this.skipEvents ||
                ...
                !this.chartRendered && 0 < this.divRealWidth && 0 < this.divRealHeight && (this.fire({ type: "rendered", chart: this }), (this.chartRendered = !0)),
        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    "H" != u
                        ? ((x = a - z / 2), b < h + w + 10 && "down" != u ? ((H = !0), e && (b += A), (A = b + B), (this.deltaSignY = -1)) : (e && (b -= A), (A = b - w - B), (this.deltaSignY = 1)))
                        : (2 * B > w && (B = w / 2), (A = b - w / 2), a < k + (l - k) / 2 ? ((x = a + B), (this.deltaSignX = -1)) : ((x = a - z - B), (this.deltaSignX = 1)));
                    A + w >= m && (A = m - w);
                    A < h && (A = h);
                    x < k && (x = k);
                    x + z > l && (x = l - z);
                    ...
                    this.drop
                        ? ((k = z / 1.6),
                          ...
                          "up" == u && ((l = 180), (x = a + 1), (A = b + k + k / 3)),
                          "left" == u && ((l = 270), (x = a + k + k / 3 + 2), (A = b)),
                          "right" == u && ((l = 90), (x = a - k - k / 3 + 2), (A = b)),
                          (h = A - F / 2 + 1),
                          (m = x - E / 2 - 1),
                          (p = d.drop(g, k, l, p, y, q, r, M)))
                        : 0 < v || 0 === B
                        ? (0 < G && ((a = d.rect(g, z, w, p, 0, q + 1, D, G, v)), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), (p = d.rect(g, z, w, p, y, q, r, M, v)))
                        : ((t = []),
                          (v = []),
                          "H" != u
                              ? ((k = a - x), k > z - B && (k = z - B), k < B && (k = B), (t = [0, k - B, a - x, k + B, z, z, 0, 0]), (v = H ? [0, 0, b - A, 0, 0, w, w, 0] : [w, w, b - A, w, w, 0, 0, w]))
                              : ((u = b - A),
                                u > w - B && (u = w - B),
                                u < B && (u = B),
                                (v = [0, u - B, b - A, u + B, w, w, 0, 0]),
                                (t = a < k + (l - k) / 2 ? [0, 0, x < a ? 0 : a - x, 0, 0, z, z, 0] : [z, z, x + z > a ? z : a - x, z, z, 0, 0, z])),
                          0 < G && ((a = d.polygon(g, t, v, p, 0, q, D, G)), a.translate(1, 1), f.push(a)),
                    ...
                    0 < this.animationDuration &&
                        ...
                        f.animate({ translate: x - g + "," + A }, b, "easeOutSine"),
                        n &&
                            ((C.left = this.prevTX + "px"),
                            (C.top = this.prevTY + "px"),
                            (this.xAnim = c.animate({ node: n }, "left", this.prevTX, m, b, "easeOutSine", "px")),
                            (this.yAnim = c.animate({ node: n }, "top", this.prevTY, h, b, "easeOutSine", "px"))));
                    this.prevX = x - g;
                    this.prevY = A;
                    this.prevTX = m;
                    this.prevTY = h;
...
(function () {
    ...
    d.triangle = function (a, b, c, e, d, f, k, h) {
        ...
        void 0 === k && (k = "#000");
        void 0 === h && (h = 0);
        e = { fill: e, stroke: k, "fill-opacity": d, "stroke-width": f, "stroke-opacity": h };
        b /= 2;
        var l;
    ...
    d.wedge = function (a, b, c, e, g, f, k, h, l, m, n, p, r, t) {
        ...
        var v = (1 / 180) * Math.PI,
            ...
            F = { fill: d.adjustLuminosity(m.fill, -0.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"] },
            H = 0;
        180 < Math.abs(g) && (H = 1);
        e = a.set();
        var G;
        ...
        if (0 < l) {
            D = " M" + u + "," + (w + l) + " L" + A + "," + (C + l);
            B
                ? (G || (D += " A" + (b - f) + "," + (l + c - k) + "," + (b + f) + "," + (l + c + k) + "," + A + "," + (C + l) + "," + x + "," + (z + l)),
                  (D += " L" + E + "," + (v + l)),
                  0 < h && (G || (D += " B" + (b - h) + "," + (l + c - y) + "," + (b + h) + "," + (l + c + y) + "," + E + "," + (l + v) + "," + u + "," + (l + w))))
                : ((D += " A" + f + "," + k + ",0," + H + ",1," + x + "," + (z + l) + " L" + E + "," + (v + l)), 0 < h && (D += " A" + h + "," + y + ",0," + H + ",0," + u + "," + (w + l)));
            D += " Z";
            var L = l;
            B && (L /= 10);
        ...
        B
            ? (G || (g = " A" + q(b - f) + "," + q(c - k) + "," + q(b + f) + "," + q(c + k) + "," + q(A) + "," + q(C) + "," + q(x) + "," + q(z)), (k = " M" + q(u) + "," + q(w) + " L" + q(A) + "," + q(C) + g + " L" + q(E) + "," + q(v)))
            : (k = " M" + u + "," + w + " L" + A + "," + C + (" A" + f + "," + k + ",0," + H + ",1," + x + "," + z) + " L" + E + "," + v);
...
(function () {
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend: function () {
            ...
            "outside" == b
                ? ((c = f.offsetWidth), (g = f.offsetHeight), f.clientHeight && ((c = f.clientWidth), (g = f.clientHeight)))
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    ...
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e)
                        (m = p.set()),
                            a.hidden || ((f = a.lineColorR), (h = a.bulletBorderColorR)),
                            (t = d.line(p, [0, 2 * r], [r / 2, r / 2], f, a.lineAlpha, a.lineThickness, a.dashLength)),
                            d.setCN(c, t, "graph-stroke"),
                            m.push(t),
                            a.bullet &&
                                (a.hidden || (f = a.bulletColorR), (t = d.bullet(p, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, h, a.bulletBorderAlpha))) &&
                                (d.setCN(c, t, "graph-bullet"), t.translate(r + 1, r / 2), m.push(t)),
                            (y = 0),
                            (t = r),
                            (q = r / 3);
                    else {
                ...
                h &&
                    "none" != h &&
                    0 < r &&
                    ("x" == h ? ((u = b.createX()), u.translate(r / 2, r / 2)) : (u = b.createV()),
                    (u.dItem = a),
        ...
        createValue: function (a) {
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                b.index++;
                e = b.container.rect(a.legendEntryWidth, 0, k, h, 0, 0).attr({ stroke: "none", fill: "#fff", "fill-opacity": 0.005 });
                e.dItem = a;
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e) f.value ? g.text(f.value) : g.text("");
                        ...
                        if (void 0 !== f.type) {
                            ...
                            h
                                ? ((k = this.valueText), f.legendValueText && (k = f.legendValueText), f.legendValueTextR && (k = f.legendValueTextR), (k = b.formatString(k, h)))
                                : l && b.formatPeriodString && ((l = d.massReplace(l, { "[[title]]": f.title })), (k = b.formatPeriodString(l, f)));
...
(function () {
    ...
    d.AmMap = d.Class({
        ...
        initChart: function () {
            ...
            if (this.sizeChanged && d.hasSVG && this.chartCreated) {
                ...
                (d.AmMap.base.initChart.call(this), d.hasSVG)
                    ? (this.dataChanged && (this.parseData(), (this.dispatchDataUpdated = !0), (this.dataChanged = !1), (a = this.legend)) && ((a.position = "absolute"), a.invalidateSize()),
        ...
        buildEverything: function () {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                isNaN(b.zoomX) &&
                    ...
                    (this.centerMap ? ((c = this.xyToCoordinates(this.mapWidth / 2, this.mapHeight / 2)), (b.zoomLongitudeC = c.longitude), (b.zoomLatitudeC = c.latitude)) : ((b.zoomX = 0), (b.zoomY = 0)), (this.zoomInstantly = !0));
        ...
        handleReleaseOutside: function () {
            if (d.isModern) {
                ...
                if (!a.preventHover) {
                    ...
                    isNaN(c) || isNaN(e) || !(3 < Math.abs(b.x - c) || 3 < Math.abs(b.y - e)) || ((a.mapWasDragged = !0), (b = { type: "dragCompleted", zoomX: a.zoomX(), zoomY: a.zoomY(), zoomLevel: a.zoomLevel(), chart: a }), a.fire(b));
                    ((a.mouseIsOver && !a.mapWasDragged && !a.skipClick) || (a.wasTouched && 3 > Math.abs(a.mouseX - a.tmx) && 3 > Math.abs(a.mouseY - a.tmy))) && a.fire({ type: "click", x: a.mouseX, y: a.mouseY, chart: a });
                ...
                if ((a = b.mapContainer)) {
                    ...
                    if (!isNaN(h)) {
                        ...
                        if (!isNaN(q)) {
                            ...
                            0.1 < Math.abs(h - k) && (b.zoomTo(h, q, l, !0), (b.mapWasPinched = !0), clearTimeout(b.pinchTO));
                        }
                    }
                    h = a.scale;
                    b.isDragging &&
                        ...
                        (c = a.x + (g - c)),
                        (e = a.y + (f - e)),
                        b.preventDragOut && ((r = -r * h + m / 2 - b.diffY * b.mapScale * h), (m = m / 2 - b.diffY * b.mapScale * h), (c = d.fitToBounds(c, -p * h + n / 2, n / 2)), (e = d.fitToBounds(e, r, m))),
                        isNaN(c) || isNaN(e) || (a.translate(c, e, h, !0), b.updateSmallMap()));
                    b.previuosMouseX = g;
                    b.previuosMouseY = f;
                }
            }
		...
		//lilyn
		setColorByGroupId: function (id, color) {
			let g = this.getGroupById(id);
			for (i = 0; i < g.length; i++) {
				...
				a.colorReal = c;
				a.color = c;
				a.image.setAttr("fill", c);
			}
			
		},
		setLinkByGroupId: function (id, link) {
			let g = this.getGroupById(id);
			for (i = 0; i < g.length; i++) {
				var a = g[i];
				a.link = link;
        ...
        returnInitialColorReal: function (a) {
            ...
            if (b) {
                ...
                "MapArea" == a.objectType &&
                    ((c = 1), this.areasSettings.adjustOutlineThickness && (c = this.zoomLevel() * this.mapScale), b.setAttr("stroke", k), b.setAttr("stroke-width", f / c), b.setAttr("fill-opacity", e), b.setAttr("stroke-opacity", g));
        ...
        zoomToRectangle: function (a, b, c, e) {
            var g = this.realWidth,
                ...
                k = this.mapSet.scale,
                h = this.zoomControl,
                g = d.fitToBounds(c / g > e / f ? (0.8 * g) / (c * k) : (0.8 * f) / (e * k), h.minZoomLevel, h.maxZoomLevel);
        ...
        zoomToLatLongRectangle: function (a, b, c, e) {
            var g = this.dataProvider,
                ...
                f = d.fitToBounds(k / l > h / g ? (0.8 * l) / k : (0.8 * g) / h, f.minZoomLevel, f.maxZoomLevel);
        ...
        zoomToObject: function (a) {
            if (a) {
                ...
                "MapArea" == a.objectType &&
                    ...
                    (e = g.width * f),
                    (g = g.height * f),
                    (h = a.autoZoomReal && isNaN(a.zoomLevel) ? (e / h > g / l ? (0.8 * h) / e : (0.8 * l) / g) : a.zoomLevel),
                    (l = this.zoomControl),
        ...
        zoomTo: function (a, b, c, e) {
            ...
            a = d.fitToBounds(a, g.minZoomLevel, g.maxZoomLevel);
            g = this.zoomLevel();
            isNaN(b) && ((b = this.realWidth / this.mapWidth), (b = (this.zoomX() - 0.5 * b) * (a / g) + 0.5 * b));
            isNaN(c) && ((c = this.realHeight / this.mapHeight), (c = (this.zoomY() - 0.5 * c) * (a / g) + 0.5 * c));
            this.stopAnimation();
            isNaN(a) ||
                ((g = this.mapContainer),
                (this.initialX = g.x),
        ...
        showAsRolledOver: function (a) {
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                "MapImage" == a.objectType
                    ? ((c = this.imagesSettings.rollOverOutlineThickness), (e = a.image) && (isNaN(c) || e.setAttr("stroke-width", c)))
                    : ((c = this.areasSettings.rollOverOutlineThickness), isNaN(c) || b.setAttr("stroke-width", c));
        ...
        formatString: function (a, b) {
            ...
            var k = b.customData;
            void 0 == k && (k = "");
            return (a = d.massReplace(a, { "[[title]]": g, "[[value]]": f, "[[percent]]": c, "[[description]]": e, "[[customData]]": k }));
        },
        mouseDownMapObject: function (a, b) {
			console.log("mouseDownMapObject",a ,b);
        ...
        checkIfClickable: function (a) {
            ...
            return this.selectedObject == a && b
                ...
                ? !0 === a.selectable || ("MapArea" == a.objectType && a.autoZoomReal) || a.url || a.linkToObject || 0 < a.images.length || 0 < a.lines.length || !isNaN(a.zoomLevel) || !isNaN(a.zoomX) || !isNaN(a.zoomY) || a.description
                    ? !0
                    : !1
                : !1;
        },
                ...
                for (g = 0; g < h; g++) {
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n)
                        if (3 == f.nodeType || 4 == f.nodeType) {
                            ...
                            void 0 !== a[b][l]
                                ? void 0 === a[b][l].length
                                    ? ((p = a[b][l]), (a[b][l] = []), a[b][l].push(p), a[b][l].push({}), (p = a[b][l][1]))
                                    : "object" == typeof a[b][l] && (a[b][l].push({}), (p = a[b][l][a[b][l].length - 1]))
                                : ((a[b][l] = {}), (p = a[b][l]));
        ...
        coordinatesToXY: function (a, b) {
            ...
            this.projectionFunction
                ? ((e = this.projectionFunction(d.degreesToRadians(a), d.degreesToRadians(b))), (c = this.mapScale * d.roundTo(this.x2c(d.radiansToDegrees(e[0])), 3)), (e = this.mapScale * d.roundTo(this.y2c(d.radiansToDegrees(e[1])), 3)))
        ...
        xyToCoordinates: function (a, b, c, e, g) {
            ...
            if ((f = c.invert)) {
                ...
                this.projectionChanged &&
                    ((l = d.radiansToDegrees(c(d.degreesToRadians(this.topLongLat.longitude), d.degreesToRadians(this.topLongLat.latitude))[1])),
        ...
        coordinateToLatitude: function (a, b) {
            ...
            if (this.mapSet) {
                ...
                "mercator" == e.projection
                    ? ((e = this.mercatorLatitudeToCoordinate(g)), (c = this.mercatorLatitudeToCoordinate(c)), (c = 2 * d.degreesToRadians((a * (e - c)) / b + c)), (c = d.radiansToDegrees(2 * Math.atan(Math.exp(c)) - 0.5 * Math.PI)))
                    : (c = (a / b) * (g - c) + c);
            }
...
(function () {
    ...
    d.ZoomControl = d.Class({
        ...
        init: function (a, b) {
            ...
            isNaN(c.bottom) || ((z = a.getY(c.bottom, !0)), f && (z -= q + 3 * g), (z = k ? z - 3 * g : c.homeButtonEnabled ? z - 0.5 * g : z + g));
            e.translate(x, z);
            c.previousDY = NaN;
            var E,
                x = g / 4 - 1;
            if (f) {
                ...
                c.zoomSet = E;
                5 < q &&
                    ((f = d.rect(b, g + 6, q + 2 * g + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, "#000000", 0, 4)),
                    d.setCN(a, f, "zoom-bg"),
                    f.translate(-3, -3),
                    f
                        .mouseup(function () {
        ...
        update: function () {
            ...
            k &&
                (this.isDragging
                    ? (k.stopDrag(), (f = e.y + (k.mouseY - this.previousY)), (f = d.fitToBounds(f, g, this.realGridHeight + g)), k.zoomTo(100 * Math.pow(a, c - (f - g) / b), NaN, NaN, !0))
                    : ((a = Math.log(k.zoomLevel() / 100) / Math.log(a)), (f = (c - a) * b + g)),
                (this.previousY = k.mouseY),
                this.previousDY != f && e && (e.translate((this.buttonSize - this.draggerSize) / 2, f), (this.previousDY = f)));
        },
    });
})();
(function () {
...
(function () {
    ...
    d.AreasProcessor = d.Class({
        ...
        createArea: function (a) {
            ...
            void 0 == e.colorSolid ||
                isNaN(a.value) ||
                ((q = Math.floor((a.value - this.minValue) / ((this.maxValue - this.minValue) / b.colorSteps))),
                q == b.colorSteps && q--,
                (q *= 1 / (b.colorSteps - 1)),
        ...
        createImage: function (a, b) {
            ...
            if (n) {
                ...
                u
                    ? (isNaN(C) && (C = 10),
                      ...
                      D.setAttr("opacity", h),
                      a.centeredReal && ((E = isNaN(a.right) ? -C / 2 : C / 2), (q = isNaN(a.bottom) ? -F / 2 : F / 2), D.translate(E, q, NaN, !0)))
                    : B &&
                      ((D = e.path(B)),
                      (u = D.getBBox()),
                      a.centeredReal ? ((E = -u.x * v - (u.width * v) / 2), isNaN(a.right) || (E = -E), (q = -u.y * v - (u.height * v) / 2), isNaN(a.bottom) || (q = -q)) : (E = q = 0),
                      D.translate(E, q, v, !0),
                      (D.x = E),
                      (D.y = q));
            D &&
            ...
            void 0 !== a.label &&
                ...
                (h = a.labelBackgroundColor) &&
                    0 < G &&
                    ((l = D.getBBox()), (e = d.rect(e, l.width + 16, l.height + 10, h, G)), d.setCN(c, e, "map-image-label-background"), void 0 != a.id && d.setCN(c, e, "map-image-label-background-" + a.id), H.push(e), (a.labelBG = e)),
                (a.imageLabel = D),
                H.push(D),
            ...
            e ? f.push(H) : g.push(H);
            H.toBack();
            H && ((H.rotation = a.rotation), isNaN(a.rotation) || H.rotate(a.rotation), a.arrays.push({ arr: this.allSvgObjects, el: H }), this.allSvgObjects.push(H));
            this.allObjects.push(a);
            ...
            isNaN(a.longitude) || isNaN(a.latitude) || !a.fixedSize || ((a.objToResize = { image: H, mapImage: a, scale: 1 }), this.objectsToResize.push(a.objToResize), a.arrays.push({ arr: this.objectsToResize, el: a.objToResize }));
        ...
        createPredefinedImage: function (a, b, c, e, g, f) {
            ...
            switch (e) {
                ...
                case "bubble":
                    ...
                    break;
                case "hexagon":
                    (g /= Math.sqrt(3)), (h = d.polygon(k, [0.866 * g, 0 * g, -0.866 * g, -0.866 * g, 0 * g, 0.866 * g], [0.5 * g, 1 * g, 0.5 * g, -0.5 * g, -1 * g, -0.5 * g], a, 1, c, b, 1));
            }
            return h;
        },
        reset: function () {
        ...
        createLine: function (a, b) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < w.length) {
                    ...
                    if (isNaN(q)) {
                        for (q = 0; q < w.length - 1; q++) (H = Math.sqrt(Math.pow(w[q + 1] - w[q], 2) + Math.pow(C[q + 1] - C[q], 2))), (a.distances[q] = H);
                        q = d.line(x, w, C, l, 1, E / n, h, !1, !1, !0);
                        l = d.line(x, w, C, l, 0.001, 5 / n, h, !1, !1, !0);
                        q.setAttr("stroke-linecap", "round");
                    } else {
                        u = 1;
                        B = { fill: "none", stroke: l, "stroke-opacity": 1, "stroke-width": E / n, "fill-opacity": 0, "stroke-linecap": "round" };
                        ...
                        q = x.path(h).attr(B);
                        l = x.path(h).attr({ "fill-opacity": 0, stroke: l, "stroke-width": 5 / n, "stroke-opacity": 0.001, fill: "none" });
                    }
                    ...
                    if ("none" != A) {
                        ...
                        if ("end" == A || "both" == A)
                            (u = w[w.length - 1]),
                                (D = C[C.length - 1]),
                                1 < w.length ? ((B = w[w.length - 2]), (I = C[C.length - 2])) : ((B = u), (I = D)),
                        ...
                        if ("start" == A || "both" == A)
                            (r = w[0]), (N = C[0]), 1 < w.length ? ((u = w[1]), (K = C[1])) : ((u = r), (K = N)), (I = (180 * Math.atan((N - K) / (r - u))) / Math.PI), isNaN(F) || (I -= F), (K = r), (I = 0 > r - u ? I - 90 : I + 90);
                        "middle" == A &&
                            ((u = w[w.length - 1]),
                            (D = C[C.length - 1]),
                            1 < w.length ? ((B = w[w.length - 2]), (I = C[C.length - 2])) : ((B = u), (I = D)),
                            ...
                            isNaN(F) || ((F = H / 2), (G -= Math.sqrt(G * G - F * F)), u >= B ? 0 > v && (G = -G) : 0 < v && (G = -G), (K -= Math.sin((I / 180) * Math.PI) * G), (N += Math.cos((I / 180) * Math.PI) * G)),
                            (I += 90));
                        r = d.polygon(x, t, h, m, p, 1, m, p, void 0, !0);
                        d.setCN(c, q, "map-line-arrow");
                        void 0 != a.id && d.setCN(c, q, "map-line-arrow-" + a.id);
    ...
    d.MapImage = d.Class({
        ...
        animate: function () {
            ...
            this.line &&
                ...
                (this.line.distances && ((b = this.line.distances[this.lineSegment] * this.chart.zoomLevel()), (b = Math.abs(b / a.baseAnimationDistance))), (this.totalFrames = Math.round(b * this.totalFrames)));
            this.frame = 0;
        ...
        init: function (a, b) {
            if (this.enabled) {
                ...
                var k = 0,
                    ...
                    m = a.fontFamily,
                    n = this.color,
                    p = { precision: a.precision, decimalSeparator: a.decimalSeparator, thousandsSeparator: a.thousandsSeparator };
